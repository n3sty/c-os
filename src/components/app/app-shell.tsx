      ...
      <KeyboardShortcutProvider>
        <main className="min-h-svh bg-background">
          <div className="flex min-h-svh w-full">
            <aside className="hidden w-58 shrink-0 border-border border-r bg-background px-3 py-4 text-foreground md:block">
                  ...
                  {navigation.map((item) => {
                    ...
                    return (
                      <Link
                        ...
                        className={cn(
                          "flex h-8 items-center gap-2.5 rounded-md px-3 text-sm text-muted-foreground transition-colors hover:bg-accent hover:text-foreground",
